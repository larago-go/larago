...
/**
 * @vue/test-utils v2.3.0
 * (c) 2023 Lachlan Miller
 * Released under the MIT License
 */

import * as Vue from 'vue';
import { nextTick, setDevtoolsHook, Transition, BaseTransition, TransitionGroup, defineComponent, h, shallowReactive, reactive, isRef, ref, createApp, transformVNodeArgs, initDirectivesForSSR, createVNode, ssrContextKey, warn, Fragment, Static, Comment, Text, mergeProps, ssrUtils, computed } from 'vue';
...
var camelize$2 = cacheStringFunction$2(function (str) {
    return str.replace(camelizeRE$2, function (_, c) { return (c ? c.toUpperCase() : ''); });
});
var capitalize$1 = cacheStringFunction$2(function (str) {
...
function matchName(target, sourceName) {
    var camelized = camelize$2(target);
    var capitalized = capitalize$1(camelized);
    return (!!sourceName &&
        (sourceName === target ||
            sourceName === camelized ||
            sourceName === capitalized ||
            capitalize$1(camelize$2(sourceName)) === capitalized));
}
...
/**
 * Compiler only.
 * Do NOT use in runtime code paths unless behind `(true !== 'production')` flag.
 */
...
var createStub = function (_a) {
    ...
    var tag = name ? "".concat(hyphenate$1(name), "-stub") : anonName;
...
function createStubComponentsTransformer(_a) {
    var _b = _a.stubs, stubs = _b === void 0 ? {} : _b, _c = _a.shallow, shallow = _c === void 0 ? false : _c, _d = _a.renderStubDefaultSlot, renderStubDefaultSlot = _d === void 0 ? false : _d;
    return function componentsTransformer(type, instance) {
        ...
        if (stub === true || shallow) {
            ...
            var newStub = (_c = (_b = (_a = config.plugins).createStubs) === null || _b === void 0 ? void 0 : _b.call(_a, {
                name: stubName,
                component: type
